...
- [JS](#js)
  ...
  - [<a name="hoisting"></a> Hoisting](#-hoisting)
  - [<a name="scope"></a>Scope](#scope)
  - [<a name="nested-scopes"></a> Nested Scopes](#-nested-scopes)
  - [<a name="variables"></a> Variables (var, let e const)](#-variables-var-let-e-const)
  - [<a name="es6-features"></a> ES6 Features](#-es6-features)
  - [<a name="pure-functions"></a> Pure Functions](#-pure-functions)
  - [<a name="currying"></a> Currying](#-currying)
  - [<a name="higher-order-functions"></a> Higher-Order Functions](#-higher-order-functions)
  - [<a name="closure"></a> Closure](#-closure)
